...
import { Api } from './api.js?v=2026.09.20.v97.2';
import { State } from './state.js?v=2026.09.20.v97.2';
import { checkAuthStatus, performLogin, handleLogout, renderUserBadge, applyPermissionMap, redirectUserByRole } from './auth.js?v=2026.09.20.v97.2';

// Carga e Inicialización de Submódulos Especializados
import './modules/core.js?v=2026.09.20.v97.2';
import './modules/bcv.js?v=2026.09.20.v97.2';
import './modules/maintenance.js?v=2026.09.20.v97.2';
import './modules/projects.js?v=2026.09.20.v97.2';
import './modules/resources.js?v=2026.09.20.v97.2';
import './modules/quotations.js?v=2026.09.20.v97.2';
import './modules/expenses.js?v=2026.09.20.v97.2';
import './modules/financial.js?v=2026.09.20.v97.2';
import './modules/materials.js?v=2026.09.20.v97.2';
import './modules/dispatch.js?v=2026.09.20.v97.2';
import './modules/rentals.js?v=2026.09.20.v97.2';
